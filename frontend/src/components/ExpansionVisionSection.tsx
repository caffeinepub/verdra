...
function MapPanel({
  ...
  const { ref: panelRef, isVisible } = useScrollReveal<HTMLDivElement>({ threshold: 0.2 });
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(15,61,46,0.7) 0%, rgba(0,0,0,0.4) 50%, rgba(15,61,46,0.6) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(76,175,80,0.12) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full min-h-[500px] text-center px-8 py-16">
        ...
        <p className="font-body text-lg max-w-md" style={{ color: 'rgba(245,241,232,0.65)' }}>
          {subtitle}
        </p>
      </div>
    </div>
...
export default function ExpansionVisionSection() {
  ...
  const { ref: arrowRef, isVisible: arrowVisible } = useScrollReveal<HTMLDivElement>({ threshold: 0.5 });

  return (
    <section
      id="expansion-vision"
      className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #050f0a 0%, #0a1a12 100%)' }}
    >
      {/* Background glow */}
      <div
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="font-body text-base max-w-xl mx-auto" style={{ color: 'rgba(245,241,232,0.6)' }}>
            Our expansion plan is rooted in a simple truth: every great movement begins locally.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            <div className="h-8 w-px" style={{ background: 'linear-gradient(180deg, rgba(76,175,80,0.5), rgba(76,175,80,0.2))' }} />
            <div
            ...
            <div className="h-8 w-px" style={{ background: 'linear-gradient(180deg, rgba(76,175,80,0.2), rgba(76,175,80,0.5))' }} />
          </div>
