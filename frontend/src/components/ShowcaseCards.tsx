  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ boxShadow: 'inset 0 0 0 1px rgba(76,175,80,0.4), 0 0 30px rgba(76,175,80,0.2)' }}
      />
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        ...
        >
          ...
          <span className="text-xs font-heading font-semibold tracking-wider uppercase" style={{ color: '#4CAF50' }}>
            {card.tagline}
          </span>
        </div>
        <p className="font-body text-sm" style={{ color: 'rgba(245,241,232,0.7)' }}>
          {card.description}
        </p>
      </div>
    </div>
...
export default function ShowcaseCards() {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(180deg, #050f0a 0%, #0a1a12 100%)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-heading font-bold text-3xl sm:text-4xl md:text-5xl" style={{ color: '#F5F1E8' }}>
