...
export default function HeroSection() {
  ...
  const lightRays = [
    ...
    { pos: 55, opacity: 0.10, skew: 1, blur: 8, rayWidth: 40 },
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, #050f0a 0%, #0F3D2E 60%, #0a2a1e 100%)' }}
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 40%, rgba(30,127,79,0.15) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-xs font-body font-medium tracking-widest uppercase" style={{ color: '#4CAF50' }}>
        ...
        >
          ...
          <em className="font-medium not-italic" style={{ color: '#4CAF50' }}>one tree at a time.</em>
        </p>
        ...
        >
          <button
            ...
            style={{
              ...
              color: '#F5F1E8',
              boxShadow: '0 0 20px rgba(76,175,80,0.4), 0 4px 20px rgba(0,0,0,0.3)',
            }}
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 35px rgba(76,175,80,0.6), 0 4px 20px rgba(0,0,0,0.3)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 20px rgba(76,175,80,0.4), 0 4px 20px rgba(0,0,0,0.3)';
            }}
          >
            Adopt a Tree
          </button>
          <button
            onClick={() => document.getElementById('life-cycle')?.scrollIntoView({ behavior: 'smooth' })}
            className="px-8 py-3.5 rounded-full font-heading font-semibold text-sm tracking-wider uppercase transition-all duration-300 hover:scale-105"
            style={{
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'rgba(245,241,232,0.14)';
              (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(76,175,80,0.4)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'rgba(245,241,232,0.08)';
      ...
      <button
        ...
        style={{ animationFillMode: 'forwards', color: 'rgba(245,241,232,0.5)' }}
      >
