import { Tag, MapPin, Navigation, Award, Bell } from 'lucide-react';
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLDivElement).style.boxShadow = '0 0 30px rgba(76,175,80,0.25), 0 20px 40px rgba(0,0,0,0.3)';
        (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(76,175,80,0.35)';
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.transform = isVisible ? 'translateY(0)' : 'translateY(40px)';
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(30,127,79,0.3), rgba(76,175,80,0.2))',
      ...
      <h3 className="font-heading font-semibold text-base mb-2" style={{ color: '#F5F1E8' }}>
        {benefit.title}
      </h3>
      <p className="font-body text-sm leading-relaxed" style={{ color: 'rgba(245,241,232,0.55)' }}>
        {benefit.description}
      </p>
    </div>
  );
...
export default function BenefitsSection() {
  ...
  const { ref: missionRef, isVisible: missionVisible } = useScrollReveal<HTMLDivElement>({ threshold: 0.2 });

  return (
    <section
      id="benefits"
      className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #050f0a 0%, #0a1a12 50%, #050f0a 100%)' }}
    >
      {/* Background glow */}
      <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(15,61,46,0.8) 0%, rgba(30,127,79,0.4) 50%, rgba(15,61,46,0.8) 100%)',
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse 60% 50% at 50% 50%, rgba(76,175,80,0.08) 0%, transparent 70%)',
            }}
          />
          ...
          <div className="relative z-10 py-16 px-8 sm:px-12 lg:px-20 text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="h-px flex-1 max-w-[80px]" style={{ background: 'linear-gradient(90deg, transparent, rgba(76,175,80,0.5))' }} />
              <div
                className="w-3 h-3 rounded-full animate-pulse"
                style={{ background: '#4CAF50', boxShadow: '0 0 12px rgba(76,175,80,0.8)' }}
              />
              <div className="h-px flex-1 max-w-[80px]" style={{ background: 'linear-gradient(90deg, rgba(76,175,80,0.5), transparent)' }} />
            </div>

            <p className="text-xs font-body font-medium tracking-widest uppercase mb-4" style={{ color: '#4CAF50' }}>
              Our Mission
            </p>
            ...
            <p className="font-body text-lg max-w-2xl mx-auto" style={{ color: 'rgba(245,241,232,0.65)' }}>
              VerdRa is committed to planting{' '}
              <span className="font-semibold" style={{ color: '#4CAF50' }}>100,000 trees</span>{' '}
              across urban landscapes by December 2026 — creating a greener, healthier future for generations to come.
            </p>

            {/* Progress visual */}
            <div className="mt-10 max-w-md mx-auto">
              <div className="flex justify-between text-xs font-body mb-2" style={{ color: 'rgba(245,241,232,0.5)' }}>
                <span>Progress</span>
              ...
              <p className="text-xs font-body mt-2 text-center" style={{ color: 'rgba(245,241,232,0.4)' }}>
