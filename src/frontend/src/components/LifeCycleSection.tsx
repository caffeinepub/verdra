...
function StageCard({
  stage,
  index,
}: { stage: (typeof stages)[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLDivElement).style.boxShadow =
            "0 0 25px rgba(76,175,80,0.35), 0 0 50px rgba(76,175,80,0.1)";
      ...
      {/* Stage name */}
      <h3
        className="font-heading font-semibold text-sm sm:text-base mb-1.5"
        style={{ color: "#F5F1E8" }}
      >
        {stage.stage}
      </h3>
...
export default function LifeCycleSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #0a1a12 0%, #0F3D2E 50%, #0a1a12 100%)",
      }}
    >
      {/* Background glow */}
      <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            From a single seed to a magnificent flowering tree — witness the
            remarkable journey of nature's artistry.
          </p>
        </div>
        ...
        <div className="hidden lg:block relative mb-4">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, rgba(76,175,80,0.3), rgba(76,175,80,0.5), rgba(76,175,80,0.3), transparent)",
            }}
          />
        </div>
