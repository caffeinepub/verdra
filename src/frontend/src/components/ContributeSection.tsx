import { Clock, Leaf, Sprout, TreePine } from "lucide-react";
...
export default function ContributeSection() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #0a1a12 0%, #050f0a 100%)",
      }}
    >
      {/* Background glow */}
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(30,127,79,0.1) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <h2
            className="font-heading font-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4"
            style={{ color: "#F5F1E8" }}
          >
            Adopt a Tree.{" "}
          ...
          >
            Be part of the movement that's transforming Tirupati — and soon, all
            of India.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-8 lg:p-12">
              ...
              >
                ...
                . Each tree comes with a personalized nameplate, geo-tag, and
                digital growth updates.
              </p>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(30,127,79,0.5), rgba(76,175,80,0.4))",
                ...
                >
                  Payment functionality is not yet active. Stay tuned for
                  launch.
                </p>
              </div>
            </div>
            ...
            >
              <h4
                className="font-heading font-semibold text-sm tracking-widest uppercase mb-8"
                style={{ color: "#4CAF50" }}
              >
                How It Works
              </h4>
